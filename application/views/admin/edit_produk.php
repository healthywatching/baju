                        ...
                        <div class="card-body">
                            <form class="forms-sample" action="" method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="nama" placeholder="Masukkan Nama Barang" name="nama" value="<?= $produk['nama_produk']; ?>" required>
                                    <?= form_error('nama', '<small class="text-danger pl-3">', '</small>') ?>
                                </div>
                                <div class="form-group">
                                    <label for="harga">Harga Produk</label>
                                    <input type="text" class="form-control" id="harga" placeholder="Masukkan Harga" name="harga" value="<?= $produk['harga']; ?>" required>
                                    <?= form_error('harga', '<small class="text-danger pl-3">', '</small>') ?>
                                </div>
                                <div class="form-group">
                                    <label for="deskripsi">Deskripsi Produk</label>
                                    <textarea name="deskripsi" id="deskripsi" class="form-control" cols="30" rows="10" placeholder="Masukkan Deskripsi..." required><?= $produk['deskripsi']; ?></textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-2">
                                            <img src="<?= base_url('assets/image/produk/') . $produk['gambar']; ?>" class="rounded" width="100">
                                        </div>
                                        <div class="col">
